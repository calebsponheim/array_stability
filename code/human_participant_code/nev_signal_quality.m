...
subject = 'Jaco'; % replace with your subject name (ex: 'Jan' or 'P1')
filenames = '.\example_input.csv'; %replace with your csv filename
...
writetable(signal_quality,['./' subject '_processed.csv'])
